...
namespace Pacman.ViewModels
{
    public class AbilityViewModel
    {
            ...
            MonoBehaviour coroutiner)
        {
            ...
            m_GameModel.OnSpendablePelletsChanged += _ => NotifyDisplayTotal();
        ...
        {
            int display = m_Progress.TotalPellets + m_GameModel.SpendablePellets;
            OnPelletsChanged?.Invoke(display);
        }

        public int DisplayTotalPellets =>
                   m_Progress.TotalPellets + m_GameModel.SpendablePellets;
        ...
        private bool TrySpendDisplay(int cost)
        {
            ...
            int fromSession = m_GameModel.SpendablePellets;
            if (fromSession >= cost)
            {
